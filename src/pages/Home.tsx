...
import { heroCarouselImages } from '../data/carouselData';
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative h-screen max-h-[800px] flex items-center">
        ...
        <HeroCarousel images={heroCarouselImages.map(img => img.url)} />
        
        {/* Time-based gradient overlay */}
        <div className={`absolute inset-0 bg-gradient-to-b ${timeBasedGradient()} opacity-70 z-10`}></div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-20">
          ...
          >
            ...
            >
              Discover events, join clubs, and stay connected with everything happening on campus.
            </motion.p>
